...
#	༊*·˚ HTML       -> Was geen tijd genoeg voor ckv
...
#	: ̗̀➛ Python     -> M05.PA.O4 - Feature #02 - 3 Nieuwe smaken // flowchart update
#	: ̗̀➛ Python     -> M05.PA.O4 - Feature #02 - 3 Nieuwe smaken // code aanpasen
...
# ✎ plan for today :) // 09-03-2023:

#	: ̗̀➛ ckv 21 van python. 
#	: ̗̀➛ een wireframes voor een desktop van html maken.
#	: ̗̀➛ Javascript Horeca aap verbeteren.
#	: ̗̀➛ Realiseer desktop versie (deel van).
