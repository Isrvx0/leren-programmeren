...
if ready == 'yes':
    print ('you are now inn a house in this forest, you have to open the door by solving the next puzzel')
else:
...
try: 
    ...
    if int (number == (num1+num2) ):
        print(f'that is right {naam}, you opened the door and got out of the house')
            ...
            print('no, that is not right {}'.format(naam) , 'you lose the game')
            print ('GAME OVER')
except:
...
if monster == 'attack':
    ...
    if choice == 'no':
        ...
        print ('---- level 3 ----')
        print (f'AWESOME {naam}! The puzzel is: for what to use (int)? choose the right character  ')
...
print (f'hello {naam} , if you want to get out this forest and win, You have to collect the 6 hidden letters. Then make the right word from it. In this box, you will find the first hiddeb letter -P-')
...
if lakepuzzel == 'yes':
    print ('great, slove the next puzzel and get the hidden letter ..')
elif lakepuzzel == 'no':
...
print ('.')
print ('.')
print ('I can help you with the answer, but you need to slove this puzzel!')
...
lastpuzzel = input ('what do you think the thing that is in the forest and can use to make fire?  ')
...
print ("you are so close for the win! THE LAST HIDEN LETTER IS -N- ! You collect all the hidden letter and now you last job is to make from them the magic word that will help you to get out this forest")
